  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 36 }}>
        ...
        >
          <Img src={staticFile("basslila-logo.png")} style={{ width: "100%", height: "100%" }} />
        </Interactive.Div>

        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <Eyebrow delay={10}>Music Academy · Webinar Funnel</Eyebrow>
          <Rise name="Brand name" delay={16}>
            <Headline size={168}>Basslila</Headline>
          </Rise>
          <Rise name="Subtitle" delay={30}>
            <Body size={44}>
              Meta Ads case study{" "}
              <span style={{ color: colors.faint, fontFamily: fonts.mono, fontSize: 36 }}>
                · their first paid campaign
              </span>
            </Body>
          </Rise>
        </div>
